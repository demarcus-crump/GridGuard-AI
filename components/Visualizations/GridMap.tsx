...
export const GridMap: React.FC<GridMapProps> = ({ data, gridStatus }) => {
  ...
  return (
    <div className="relative w-full h-full bg-[var(--bg-secondary)] rounded-lg overflow-hidden flex items-center justify-center p-4">
      ...
      <svg 
        viewBox="0 0 300 320" 
        className="w-full h-full max-h-[400px] drop-shadow-xl"
      ...
      {/* Legend / Overlay */}
      <div className="absolute bottom-4 right-4 bg-[var(--bg-primary)]/90 backdrop-blur border border-[var(--border-muted)] p-3 rounded-lg shadow-lg">
