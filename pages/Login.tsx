...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] flex relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[var(--bg-primary)] via-transparent to-[var(--bg-primary)] z-0"></div>

      {/* LEFT SIDE: THE MISSION BRIEFING */}
      <div className="hidden lg:flex w-1/2 flex-col justify-between p-16 z-10 relative border-r border-[var(--border-muted)] bg-[var(--bg-primary)]/60 backdrop-blur-sm">
        <div className="flex flex-col h-full relative">
          ...
          <div className="mt-auto pt-8 border-t border-[var(--border-muted)] flex items-start justify-between opacity-60">
            ...
            <button
              ...
              className="flex items-center gap-2 text-xs font-mono text-[var(--text-link)] hover:text-[var(--text-inverse)] transition-colors border border-[var(--text-link)] px-3 py-1.5 rounded hover:bg-[var(--text-link)] hover:border-transparent"
            >
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 z-10">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="bg-[var(--bg-secondary)] border border-[var(--border-default)] rounded-lg shadow-2xl p-8 relative overflow-hidden group">
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-[var(--bg-tertiary)] border border-[var(--border-default)] text-[var(--text-primary)] px-4 py-3 rounded text-sm font-mono focus:outline-none focus:border-[var(--status-info)] focus:ring-1 focus:ring-[var(--status-info)] transition-all"
                  placeholder="••••••••••••"
                  autoFocus
                />
              </div>
                ...
                {(!API_CONFIG.GRID_STATUS_KEY || !API_CONFIG.GOOGLE_API_KEY) && (
                  <div className="grid grid-cols-1 gap-3">
                    <input
                      ...
                      className="w-full bg-[var(--bg-tertiary)] border border-[var(--border-default)] text-[var(--text-secondary)] px-3 py-2 rounded text-xs font-mono focus:outline-none focus:border-[var(--border-emphasis)]"
                    />
                    <input
                      type="password"
                      value={aiKey}
            ...
            <div className="mt-6 p-3 bg-[var(--bg-tertiary)] rounded border border-[var(--border-muted)] h-24 overflow-hidden font-mono text-[10px] text-[var(--status-success)] opacity-60">
