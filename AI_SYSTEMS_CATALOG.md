...
| ID | Component | Purpose | Model | Risk Level |
|----|-----------|---------|-------|------------|
| LIVE-001 | `subscribeToLiveThreats()` | Real-time threat detection | Rule-based | Medium |
| LIVE-002 | `useChartTheme()` | Reactive theme for visualizations | MutationObserver | Low |
